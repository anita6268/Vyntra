...
/**
 * Premium "Clear chat" confirmation modal (Vyntra style).
 * Confirms before clearing the entire conversation. Calls the backend
 * clear-chat endpoint (soft-delete, persisted) via onConfirm.
 */
function ClearChatModal({ isOpen, onClose, onConfirm, contactName }) {
        ...
        >
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-semibold text-[color:var(--text-primary)]">Clear chat?</h3>
                <p className="mt-1 text-sm text-[color:var(--text-muted)]">
                  This will remove all messages in your conversation with {contactName || "this contact"}.
